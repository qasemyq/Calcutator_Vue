<template>
    <b-card class="mt-4 p-0">
        <!-- age dovvomin operand ya hamun shomare bashe uno neshun bede dar geire in sura || ya(or) avvalin shomare ya operand ro neshun bede -->
        <div class="output-screen p-2 d-flex align-items-center">{{ secondOperand || firstOperand || 0 }}</div>
